...
var Transaction_Maria = function (_Transaction) {
  ...
  function Transaction_Maria() {
    ...
    return (0, _possibleConstructorReturn3.default)(this, (Transaction_Maria.__proto__ || (0, _getPrototypeOf2.default)(Transaction_Maria)).apply(this, arguments));
  }

  (0, _createClass3.default)(Transaction_Maria, [{
    key: 'query',
