...
(0, _assign3.default)(Builder.prototype, {
  ...
  where: function where(column, operator, value) {
    ...
    if (column instanceof Builder) {
      if (column._single.table) {
        throw new Error('You passed a query builder into appendWhere() that has a table (' + column._single.table + ') specified for it');
      }
      column._statements.map(function (_this) {
        return function (statement) {
          if (statement.grouping != 'where') throw new Error('You passed a query builder into appendWhere() that had' + ' a non-where clause on it.');
          _this._statements.push((0, _clone3.default)(statement));
        };
      }(this));
      return this;
    }
  ...
  orWhere: function orWhere() {
    this._bool('or');
    var obj = arguments[0];
    if ((0, _isObject3.default)(obj) && !(0, _isFunction3.default)(obj) && !(obj instanceof _raw2.default) && !(obj instanceof Builder)) {
